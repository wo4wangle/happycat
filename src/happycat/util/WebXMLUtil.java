...
import static happycat.util.Constant.webXmlFile;
//parse web.xml
public class WebXMLUtil {
    ...
    public static synchronized String getMimeType(String extName) {
        //at the first time this method could be invoked by muti-threads at same
        //synchronized prevent minmeTpyeMapping from being generated muti-times

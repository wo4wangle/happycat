...
import happycat.servlets.DefaultServlet;
import happycat.servlets.InvokerServlet;
import happycat.servlets.JspServlet;
import happycat.util.Constant;
import happycat.util.SessionManager;
...
//handle different http response status like 200 404 500 302
//handle session
